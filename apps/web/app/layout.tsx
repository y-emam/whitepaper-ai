...
export const metadata: Metadata = {
  ...
  description:
    "Citation-grounded RAG search across 39 AWS whitepapers. Hybrid vector + full-text retrieval, refusal when context is insufficient, MCP server for Claude Desktop.",
